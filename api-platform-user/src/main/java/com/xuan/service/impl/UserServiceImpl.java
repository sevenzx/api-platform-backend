...
import static com.xuan.constant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
	...
	public long userRegister(String userAccount, String userPassword, String checkPassword) {
		...
		synchronized (userAccount.intern()) {
			...
			// 3. 分配 key、secret
			String key = "cli_" + DigestUtil.md5Hex(SALT + userAccount + RandomUtil.randomNumbers(4));
			String secret = DigestUtil.md5Hex(SALT + userAccount + RandomUtil.randomNumbers(8));
			// 4. 插入数据
			User user = new User();
